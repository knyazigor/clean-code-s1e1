...
var incompleteTaskHolder=document.querySelector(".todo__incompleted-tasks");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".todo__completed-tasks");//completed-tasks
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("todo__task-wrapper_edit-mode");
